...
class AMP{
    ...
    public: 
        ...
        T N; // Size of the code_message/ Number of rows of the coding matrix F 
        T M; // number of columns of the coding matrix F
        /*
...
*/
void AMP::gen_sparse_code(const R& power_allocation){
...
*/
void AMP::gen_design_matrix(const R& rate){
   
    this->M = (T) (this->N * std::log2(this->B)) / (rate * this->B);
...
*/
void AMP::gen_codeword(const R& snr){
