...
class AMP{
    ...
    public: 
        ...
        */
        ...
        void gen_sparse_code(const double& power_allocation=1); // Generate sparse superposition code
        ...
        */
       void get_decoded_message(const double &snr, const double &rate, const int&t_max, const double&error_th);
