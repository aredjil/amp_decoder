...
/*
 Decode the codeword 
*/
void AMP::get_decoded_message(const double &snr, const double &rate, const int&t_max, const double&error_th, const double&power_allocation){
    codeword = this->codeword;
    double delta = 1 + error_th; 
