...
public:
    ...
    */
    ...
    void compute_z(const std::vector<double>&F_copy, const std::vector<double>&x_hat, const std::vector<double>&V, const std::vector<double>&V_old, const std::vector<double>&z_old, codeword, snr, z)
