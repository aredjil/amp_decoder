...
public:
    ...
    */
    ...
    void g(std::vector<double>&z_old, std::vector<double>&codeword, std::vector<double>&V_old, const double &snr, std::vector<double>&result);
...
void AMP::get_decoded_message(const double &snr, const double &rate, const int &t_max, const double &error_threshold, const double &power_allocation)
{
    ...
    while (t < t_max)
    {
        ...
        this->compute_z(F_copy, x_hat, V, V_old, z_old, codeword, snr, z);
