...
public:
    ...
    */
    ...
    void compute_z(const std::vector<double>&F_copy, const std::vector<double>&x_hat, const std::vector<double>&V, const std::vector<double>&V_old, const std::vector<double>&z_old, const std::vector<double>&codeword, const double &snr, std::vector<double>&z);
 ...
 * Compute z 
 */
void AMP::compute_z(const std::vector<double>&F_copy, const std::vector<double>&x_hat, const std::vector<double>&V, const std::vector<double>&V_old, const std::vector<double>&z_old, const std::vector<double>&codeword, const double &snr, std::vector<double>&z){
    std::vector<double> F_xhat(this->M, 0.0); 
    std::vector<double> frac_buffer(V.size()); // A buffer to the hold the result of the fraction operation
    std::vector<double> sub_buffer(codeword.size()); // Buffer to hold the result of the substraction operation 
    // Compute y - z 
    std::transform(
        codeword.begin(), 
        codeword.end(), 
