...
public:
    ...
    */
   std::vector<double> compute_matrix_vector_multiplication(const std::vector<double> &Mat, const std::vector<double>&Vev);
private:
...
/*
    Compute Matrix-Vector multiplication
*/
std::vector<double> AMP::compute_matrix_vector_multiplication(const std::vector<double> &Mat, const std::vector<double>&Vev){
        int m = Vec.size(); 
        int n = Mat.size() / m; 
