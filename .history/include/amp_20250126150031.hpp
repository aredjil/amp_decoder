...
public:
   ...
   std::vector<double> compute_matrix_vector_multiplication(const std::vector<double> &Mat, const std::vector<double>&Vec);
    /*
        Compute z 
    */
   std::vector<double> compute_z(const std::vector<double> &F, const std::vector<double> &x_hat, const std::vector<double> &codeword, const std::vector<double> &V, const std::vector<double> &V_old, const std::vector<double> &z_old, snr);
private:
