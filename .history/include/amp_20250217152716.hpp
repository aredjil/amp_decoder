...
void AMP::solve(){
    ...
    std::vector<double> V_new(M, 1.0); // vector to hold the result of the matrix multiplication  
    std::vector<double> V_old(M);
    std::vector<double> Fa(M, 1.0); // Store the result of matrix vector multiplication
    std::vector<double> a(N, 1.0); // Store the estimation of the message 
