...
// Compute cavity mean 
void AMP::compute_cavity_mean(std::vector<double> a, std::vector<double> sigma_new, std::vector<double> V_new, std::vector<double> omega_new, std::vector<double> )
