...
public:
    ...
    */
    ...
    void compute_onsegar(const std::vector<data_t> & omega_old, std::vector<data_t> V_new, std::vector<data_t> V_old, std::vector<data_t> a_old, std::vector<data_t> &omega_new);
