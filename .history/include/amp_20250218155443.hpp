...
public:
    ...
    */
    ...
    // Compute cavity mean
    void compute_cavity_mean(const std::vector<data_t> & a_old, const std::vector<data_t> & sigma_new, const std::vector<data_t> & V_new, std::vector<data_t> omega_new, std::vector<data_t> &cavity_mean);
