...
public:
    ...
    */
    ...
    // Compute the error 
    data_t compute_dif(const std::vector<data_t> &a_new, const std::vector<data_t> &a_old, data_t &diff);
    ...
    data_t compute_mse(const std::vector<data_t>& a_new, data_t &mse_err);
    // Solver
    void solve();
