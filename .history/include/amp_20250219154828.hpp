/**
 * This header contains the declaration of the Approxumate Message-Passing class class along with it's member variables and methods 
 */
#ifndef AMP_H
#define AMP_H
...
/**
 * Approxumate Message-Passing class 
 */
class AMP
{
