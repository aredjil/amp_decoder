...
plot "./data/data_1.3.txt" using 1:2 with lines title "R=1.3",\
     "./data/data_1.4.txt" using 1:2 with lines title "R=1.3",\
     "./data/data_1.45.txt" using 1:2 with lines title "R=1.3",\
     "./data/data_1.6.txt" using 1:2 with lines title "R=1.3"
