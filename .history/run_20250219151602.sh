...
do 
    ...
    ./main_ser.x -l $L -b 4 -r $r > ./data/data_ser_$r_.txt 
    ./main_ser.x -l $L -b 4 -r $r > ./data/data_mse_$r_.txt 
done 
gnuplot plot_mse.gp # Generate MSE plot, it will be saved as mse_figure.png in figures 
gnuplot plot_ser.gp # Generate MSE plot, it will be saved as mse_figure.png in figures 
