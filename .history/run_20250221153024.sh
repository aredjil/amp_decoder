...
do 
    ...
    ./main_ser.x -l $L -r $r -b $B > ./data/data_ser_${r}_.csv 
    ./main_mse.x -l $L -r $r -b $B > ./data/data_mse_${r}_.csv 
done 
end=`date +%s`
echo Execution time was `expr $end - $start` seconds.echo "Generating plots"
