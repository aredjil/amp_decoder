...
void AMP::solve()
{
    ...
    int t = 0;
    int t_max = 30; // Maximum number of steps

    std::vector<data_t> mse_err(t_max, 1.0); // vector to hold the mean square error at each iteration
