 ...
 */
template <typename T>
AMP::AMP<T>(const int    &number_of_sections,
 ...
 */
void AMP::update_V(const std::vector<T> &v, std::vector<T> &V)
{
for (int mu = 0; mu < M; mu++) // Iterate over the rows 
{
    T sum = 0.0;
 ...
 */
void AMP::compute_onsegar(const std::vector<T> &omega_old, const std::vector<T> &V_new, const std::vector<T> &V_old, const std::vector<T> &a_old, std::vector<T> &omega_new)
{
    for (int mu = 0; mu < M; mu++) // Iterate over the rows 
    {
        T sum = 0.0;
 ...
 */
void AMP::compute_cavity_var(const std::vector<T> &V_new, std::vector<T> &sigma_new)
{
 ...
 */
void AMP::compute_cavity_mean(const std::vector<T> &a_old, const std::vector<T> &sigma_new, const std::vector<T> &V_new, const std::vector<T> &omega_new, std::vector<T> &cavity_mean)
{
 ...
 */
void AMP::denoise_a(const std::vector<T> &sigma_new, const std::vector<T> &cavity_mean, std::vector<T> &a_new)
{
 ...
 */
void AMP::denosie_v(const std::vector<T> &a_new, std::vector<T> &v_new)
{
 ...
 */
T AMP::compute_dif(const std::vector<T> &a_new, const std::vector<T> &a_old)
{
    T sum = 0.0;
 ...
 */
void AMP::amplify(std::vector<T> a_new, std::vector<T> &a_temp)
{
    for (int i = 0; i < L; i++)
    {
 ...
 */
T AMP::compute_mse(const std::vector<T> &a_new)
{
    T err = 0.0;
 ...
 */
T AMP::compute_ser(const std::vector<T> &a_temp)
{
 ...
 */
void AMP::solve(const int &t_max, const T &ep)
{
