...
def main():
    ...
    for L in section_sizes:
        ...
        plt.scatter(idx_min, min_pt, marker=".", s=200, label="Minimum")
        plt.xlim(0, )
    ...
    plt.title(f"""Section Error Rate (SER) Vs number of iterations for different number of sections with  R = {r} and B = 4. Using {number_of_files} runs """)
    plt.tight_layout()
