...
NOTE: Make the functionality of the main similar to that of c++ implementation so you can redirect the results
to a csv file and later on plot the results 
"""
